  ...
  return (
    <div id="notificationsviewercomponent" className='container'>
      ...
      <Row className='propertyview pageheader' key={'header'}>
        ...
        <Col md={3}><label className="leftaligntext">Actor</label></Col>
  ...
  return (
    <div className={`NotificationCard`}>
      <Row className='propertyview' key={notification.metadata.id}>
        <Col md={1}><label className='leftaligntext'><b>{notification.type.split('#')[1]}</b></label></Col>
        <Col md={3}><label className='leftaligntext'><a href={notification.actor}><Value src={`[${notification.actor}].name`}/></a></label></Col>
